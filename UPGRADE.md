...
- `0` keeps confirmation scoped to the current browser session; positive values remember confirmation in the same browser for the configured number of days.
