...
它以标准 WHMCS Addon Module 形式提供后台配置页面、中英文后台文本、可编辑的结账弹窗内容，以及持久化的风险处理记录。
...
- 结账确认会绑定当前浏览器、IP 地址和购物车内容，同一结账流程不会重复弹窗。
- 弹窗标题、正文、提示项、按钮和校验提示均可在后台修改。
- 支持简体中文、香港繁体中文和英文结账弹窗内容。
- 支持中文和英文后台界面文本，并支持香港繁体中文结账文案。
...
- **结账提醒记忆天数**：同一浏览器确认后多少天内不再弹窗。填 `0` 表示仅在当前会话内记住确认；当前浏览器、IP 地址和购物车内容仍会参与确认范围判断。
